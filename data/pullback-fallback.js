...
window.DATA_PULLBACKS = [
  { kw: ['你是谁','你叫什么','你是什么','你是啥','你谁','什么助手','哪个ai','你的名字','自我介绍','介绍一下自己','介绍自己'],  intentId:'welfare',  label:'🤖 自我介绍',  reply:'我是<strong>YoYo</strong>！🎮 你可以让我帮你查战绩、领福利、找搭子、AI复盘……有啥游戏问题尽管问我～', qr:['今天有什么福利','查查我的战绩','帮我找个搭子'], _sceneKey:'who_are_you' },
